...
"Alt + Shift + e" "Launch Text Editor (deepin-editor)" "#cccccc" "Monospace 16" \
"Alt + Shift + b" "Launch Web Browser (firefox)" "#ffffff" "Monospace 16" \
"Alt + Shift + s" "Launch System Setting (dde-control-center --show)" "#cccccc" "Monospace 16" \
"Alt + Enter" "Launch Terminal (deepin-terminal)" "#ffffff" "Monospace 16" \
"Alt + Shift + a" "Launch Terminal (deepin-terminal)" "#cccccc" "Monospace 16" \
"Alt + Ctrl + a" "Launch Terminal (sakura)" "#ffffff" "Monospace 16" \
"Alt + Shift + t" "Launch Terminal (deepin-terminal)" "#cccccc" "Monospace 16" \
