...
"Alt + Shift + e" "開啟 (deepin-editor)" "#cccccc" "Monospace 16" \
"Alt + Shift + b" "開啟網頁瀏覽器 (firefox)" "#ffffff" "Monospace 16" \
"Alt + Shift + s" "開啟系統設定 (dde-control-center --show)" "#cccccc" "Monospace 16" \
"Alt + Enter" "開啟 Terminal (deepin-terminal)" "#ffffff" "Monospace 16" \
"Alt + Shift + a" "開啟 Terminal (deepin-terminal)" "#cccccc" "Monospace 16" \
"Alt + Ctrl + a" "開啟 Terminal (sakura)" "#ffffff" "Monospace 16" \
"Alt + Shift + t" "開啟 Terminal (deepin-terminal)" "#cccccc" "Monospace 16" \
