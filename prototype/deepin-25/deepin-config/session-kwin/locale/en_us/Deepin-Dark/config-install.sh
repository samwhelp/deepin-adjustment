...
deepin_config_run_post () {

	#deepin_service_start
...
deepin_config_install () {
	...
	deepin_config_install_by_dir

	deepin_config_install_by_gsettings
...
deepin_config_install_by_gsettings () {
	...
	deepin_config_install_by_gsettings_keybind
